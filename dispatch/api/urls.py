...
router.register(r'podcasts', views.PodcastViewSet, base_name='api-podcasts')
router.register(r'podcast-episodes', views.PodcastEpisodeViewSet, base_name='api-podcast-episodes')
