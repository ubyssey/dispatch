...
class ImageGalleryTests(DispatchAPITestCase, DispatchMediaTestMixin):
    ...
    def _create_gallery_only(self, id, attachment):
        """
    ...
    def _create_gallery(self, id):
        ...
        """
        id1 = self._upload_image()
        id2 = self._upload_image()
        ...
        return (self._create_gallery_only(id, attachment), id1, id2)
    ...
    def test_imagegallery_get_invalidd(self):
        """
    ...
    def test_imagegallery_delete_invalid_id(self):
        """
        Ensure that deleting invalid id returns the appropriate erro
        """
        id = -1
        url = reverse('api-galleries-detail', args=[id])
        response = self.client.delete(url, None, format='json')
